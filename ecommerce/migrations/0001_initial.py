    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Discipline', to='ecommerce.discipline')),
                ('formules', models.ManyToManyField(related_name='formule_choisie', to='ecommerce.formule')),
            ],
            options={
                'ordering': ['-date_added'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evenements', models.ManyToManyField(related_name='commandes_evenements', to='ecommerce.evenement')),
                ('formules', models.ManyToManyField(related_name='commandes_formules', to='ecommerce.formule')),
            ],
        ),
    ]
